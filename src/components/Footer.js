  ...
  <div className="md:mx-3 text-gray-700 xl:max-w-6xl xl:mx-auto max-w-[576px] md:max-w-full mx-auto px-3">
    ...
    <div className="flex md:gap-x-2.5 lg:gap-x-10 mb-2 flex-wrap md:flex-nowrap">
      <div className="max-w-[60%]">
        <div className="mt-6 max-w-full md:max-w-[50%] mb-8">
          Discover thousands of meals, drinks & cocktails, add them to wishlists
          and generate automatic shopping lists.
        </div>
      </div>
      <div className="flex gap-x-16 lg:gap-x-36 xl:gap-x-48 2xl:gap-x-64 mb-4 pr-10">
        <div className="flex flex-col">
          <div className="truncate font-extrabold mb-2">Discover more</div>
          <Link to="/wishlists" className="text-sm mb-2 hover:text-gray-800">
            Wishlists
          </Link>
          <Link to="/shoppinglist" className="text-sm mb-2 hover:text-gray-800">
            Shopping list
          </Link>
        </div>
        <div>
